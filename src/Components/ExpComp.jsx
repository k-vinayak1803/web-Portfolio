    ...
    <div className="box-content" key={index}>
      <div className="row justify-content-center">
        ...
        <div className="p-4 bg-dark">
          ...
          <div className="ps-5">
            <p>company: <span style={{ color: "#ffbd2e" }}>{exp.company}</span>,</p>
            <p>location: <span style={{ color: "#ffbd2e" }}>{exp.location}</span>,</p>
            <p>duration: <span style={{ color: "#ffbd2e" }}>{exp.duration}</span>,</p>
            
            <p><span style={{ color: "#4ec9b0" }}>responsibilities</span>: [</p>
            <ul>
